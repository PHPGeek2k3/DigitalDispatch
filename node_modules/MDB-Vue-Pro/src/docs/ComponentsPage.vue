      ...
      <column md="8" class="mx-auto">
        <jumbotron class="mt-5">
          ...
          <ul class="list-unstyled example-components-list">
            ...
            <a href="#/components/pro/footer"><li>Footer <fa icon="angle-right"/></li></a>
            <a href="#/components/pro/forms"><li>Forms <fa icon="angle-right"/></li></a>
            ...
            <a href="#/components/pro/search"><li>Search <fa icon="angle-right"/></li></a>
