      ...
      <row>
        <column lg="3" md="6" class="mb-lg-0 mb-4">
          <card narrow ecommerce>
            ...
            <card-body class="text-center" cascade>
    ...
    <section class="text-center my-5">
      ...
      <row>
        <column lg="4" md="12" class="mb-lg-0 mb-4">
          <card wide ecommerce>
            <view-wrapper overlay="white-slight" cascade>
              <card-img src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Products/img (55).jpg" top alt="sample photo" waves/>
            </view-wrapper>
            <card-body class="text-center" cascade>
        ...
        <column lg="4" md="12" class="mb-lg-0 mb-4">
          <card wide ecommerce>
            <view-wrapper overlay="white-slight" cascade>
              <card-img src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Products/img (49).jpg" top alt="sample photo" waves/>
            </view-wrapper>
            <card-body class="text-center" cascade>
              <a href="" class="text-muted">
                <h5>Photography</h5>
        ...
        <column lg="4" md="12" class="mb-lg-0 mb-4">
          <card wide ecommerce>
            <view-wrapper overlay="white-slight" cascade>
              <card-img src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Products/img (56).jpg" top alt="sample photo" waves/>
            </view-wrapper>
            <card-body class="text-center" cascade>
              <a href="" class="text-muted">
                <h5>Smartphone</h5>
      ...
      <row>
        <column lg="3" md="6" class="mb-lg-0 mb-4">
          <card class="align-items-center">
            <view-wrapper hover>
              <card-img top src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/12.jpg" alt="sample photo"/>
              <a><md-mask overlay="white-slight" waves/></a>
            </view-wrapper>
        ...
        <column lg="3" md="6" class="mb-lg-0 mb-4">
          <card class="align-items-center">
            <view-wrapper hover>
              <card-img top src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/13.jpg" alt="sample photo"/>
              <a><md-mask overlay="white-slight" waves/></a>
            </view-wrapper>
            <card-body class="text-center">
              <a href="" class="grey-text">
        ...
        <column lg="3" md="6" class="mb-lg-0 mb-4">
          <card class="align-items-center">
            <view-wrapper hover>
              <card-img top src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/14.jpg" alt="sample photo"/>
              <a><md-mask overlay="white-slight" waves/></a>
            </view-wrapper>
            <card-body class="text-center">
              <a href="" class="grey-text">
        ...
        <column lg="3" md="6" class="mb-lg-0 mb-4">
          <card class="align-items-center">
            <view-wrapper hover>
              <card-img top src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/15.jpg" alt="sample photo"/>
              <a><md-mask overlay="white-slight" waves/></a>
            </view-wrapper>
            <card-body class="text-center">
              <a href="" class="grey-text">
          ...
          <carousel-inner>
            <row>
              <carousel-item :class="{active: show[0]}">
                <column md="4">
                  <card narrow ecommerce class="mb-2">
...
<script>
import { Container, Row, Column, Card, CardImg, CardBody, CardTitle, CardFooter, CardText, Fa, Btn, Tooltip, Badge, ViewWrapper, Carousel, CarouselIndicators, CarouselIndicator, CarouselInner, CarouselItem, CarouselNavigation, CarouselCaption, Testimonial, Avatar, MdMask  } from 'mdbvue';
