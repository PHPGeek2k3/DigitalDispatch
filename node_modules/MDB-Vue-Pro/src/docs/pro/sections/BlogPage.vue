  ...
  <container>
      ...
      <column lg="7">
        <a class="green-text">
          <h6 class="font-weight-bold mb-3">
            <fa icon="cutlery" class="pr-2" />Food</h6>
        </a>
        ...
        <btn color="success" size="md" class="waves-light ">Read more</btn>
      </column>
    </row>
    <hr class="my-5" />
    <row>
      <column lg="7">
        <a class="pink-text">
          <h6 class="font-weight-bold mb-3">
            <fa icon="image" class="pr-2" />Lifestyle
          </h6>
        </a>
        <h3 class="font-weight-bold mb-3 p-0">
          <strong>Title of the news</strong>
        ...
        <btn color="pink" size="md" class="mb-lg-0 mb-4 waves-light">Read more</btn>
      </column>
      <column lg="5">
        <view-wrapper class="rounded z-depth-2 mb-lg-0 mb-4" hover>
    ...
    <row>
      ...
      <column lg="7">
        <a class="indigo-text">
          <h6 class="font-weight-bold mb-3">
            <fa icon="suitcase" class="pr-2" />Food</h6>
        </a>
        <h3 class="font-weight-bold mb-3 p-0">
          <strong>Title of the news</strong>
        </h3>
        ...
        <btn color="indigo" size="md" class="waves-light ">Read more</btn>
      </column>
    </row>
    ...
    <row>
      <column lg="4" md="12" class="mb-lg-0 mb-4">
        ...
        <a class="pink-text">
          <h6 class="font-weight-bold mb-3">
            <fa icon="map" class="pr-2" />Adventure</h6>
        </a>
        ...
        <p class="dark-grey-text">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere
          possimus voluptas.</p>
        <btn color="pink" rounded size="md">Read more</btn>
      </column>
      <column lg="4" md="12" class="mb-lg-0 mb-4">
        <view-wrapper hover class="rounded z-depth-2 mb-4">
        ...
        <a class="deep-orange-text">
          <h6 class="font-weight-bold mb-3">
            <fa icon="graduation-cap" class="pr-2" />Education</h6>
        </a>
        <h4 class="font-weight-bold mb-3">
          <strong>Title of the news</strong>
        </h4>
        ...
        <btn color="deep-orange" rounded size="md">Read more</btn>
      </column>
      <column lg="4" md="12" class="mb-lg-0 mb-4">
        <view-wrapper hover class="rounded z-depth-2 mb-4">
        ...
        <a class="blue-text">
          <h6 class="font-weight-bold mb-3">
            <fa icon="fire" class="pr-2" />Culture</h6>
        </a>
        <h4 class="font-weight-bold mb-3">
          <strong>Title of the news</strong>
        </h4>
        ...
        <p class="dark-grey-text">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos
          qui ratione.</p>
        <btn color="info" rounded size="md">Read more</btn>
      </column>
    </row>
    ...
    <row>
      ...
      <column lg="7" xl="8">
        ...
        <btn color="primary" size="md">Read More</btn>
      </column>
    </row>
    <hr class="my-5" />
    <row>
      ...
      <column md="12">
        <card reverse>
          <view-wrapper hover cascade>
            ...
            <md-mask overlay="white-slight" class="waves-light" waves/>
          </view-wrapper>
          <card-body class="text-center" cascade>
            ...
            <btn class="btn-fb waves-light">
              <fa icon="facebook" class="pr-2"/>
              Facebook
            </btn>
            <span class="counter">46</span>
            <btn class="btn-tw waves-light">
              <fa icon="twitter" class="pr-2"/>
              Twitter
            </btn>
            <span class="counter">22</span>
            <btn class="btn-gplus waves-light">
              <fa icon="google-plus" class="pr-2"/>
              Google
            </btn>
            <span class="counter">31</span>
            <btn color="default" class="waves-light">
              <fa icon="comments" class="pr-2"/>
              Comments
            </btn>
